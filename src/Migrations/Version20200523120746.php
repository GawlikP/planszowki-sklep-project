 ...
 */
final class Version20200523120746 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE `order` (id_order INT AUTO_INCREMENT NOT NULL, users_id INT NOT NULL, order_date DATE NOT NULL, finalization_date DATE DEFAULT NULL, basket VARCHAR(1024) NOT NULL, price NUMERIC(12, 2) NOT NULL, status VARCHAR(255) DEFAULT NULL, INDEX IDX_F529939867B3B43D (users_id), PRIMARY KEY(id_order)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE `order` ADD CONSTRAINT FK_F529939867B3B43D FOREIGN KEY (users_id) REFERENCES user (id_user)');
    }
